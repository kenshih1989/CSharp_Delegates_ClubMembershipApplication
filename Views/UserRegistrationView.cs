    ...
    internal class UserRegistrationView : IView
    {
        ...
        public void RunView()
        {
            ...
            _fieldValidator.FieldArray[(int)FieldConstants.UserRegistrationField.PasswordCompare]
                = GetInputFromUser(
                    FieldConstants.UserRegistrationField.PasswordCompare,
                    "Please re-enter your password: ");
            _fieldValidator.FieldArray[(int)FieldConstants.UserRegistrationField.DateOfBirth]
                = GetInputFromUser(
                    FieldConstants.UserRegistrationField.DateOfBirth,
            ...
            _fieldValidator.FieldArray[(int)FieldConstants.UserRegistrationField.PhoneNumber]
                = GetInputFromUser(
                    FieldConstants.UserRegistrationField.PhoneNumber,
                    "Please enter your mobile phone number: ");
            _fieldValidator.FieldArray[(int)FieldConstants.UserRegistrationField.AddressFirstLine]
                = GetInputFromUser(
                    FieldConstants.UserRegistrationField.AddressFirstLine,
            ...
            _fieldValidator.FieldArray[(int)FieldConstants.UserRegistrationField.AddressSecondLine]
                = GetInputFromUser(
                    FieldConstants.UserRegistrationField.AddressSecondLine,
        ...
        private bool FieldValid(FieldConstants.UserRegistrationField field, string fieldVal)
        {
            ...
            if (!_fieldValidator.GetFieldValidator((int)field, fieldVal, _fieldValidator.FieldArray, out string fieldErrorMessage))
            {
                CommonOutputFormat.ChangeFontColor(FontTheme.Danger);

                Console.WriteLine(fieldErrorMessage);
